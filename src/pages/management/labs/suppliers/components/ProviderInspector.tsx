...
export const ProviderInspector: React.FC<ProviderInspectorProps> = ({
  ...
  return (
    <>
      {/* Desktop: Aside integrado en layout de 3 paneles */}
      <aside className="hidden lg:flex flex-col h-full bg-white border-l border-[#DDDDCF]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#E5E5DA] flex-shrink-0">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 text-[14px] bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-0 transition-colors ${
                  errors.name 
        ...
        {/* Footer Actions */}
        <div className="px-6 py-4 border-t border-[#E5E5DA] bg-white flex-shrink-0">
      ...
      {/* Mobile: Full Screen Sheet (sin backdrop oscuro) */}
      <div className="lg:hidden fixed inset-0 z-50 flex flex-col bg-white">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#E5E5DA] flex-shrink-0">
          <button
            onClick={onClose}
        ...
        <div className="px-4 py-3 border-t border-[#E5E5DA] bg-white flex-shrink-0">
